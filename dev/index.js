...
/* harmony import */ var _styles_sunrise_sunset_style_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../styles/sunrise-sunset-style.css */ "./src/styles/sunrise-sunset-style.css");
/* harmony import */ var _tempBar__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./tempBar */ "./src/modules/tempBar.js");
/* harmony import */ var _timezoneFormatter__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./timezoneFormatter */ "./src/modules/timezoneFormatter.js");
...
const updateDailyForecast = (locationData, tempType) => {
    ...
    for (let i = 7; i < 18; i++) {
        ...
        const barElement = (0,_tempBar__WEBPACK_IMPORTED_MODULE_6__["default"])(minTemp, maxTemp);
...
const updateSunriseSunset = (locationData) => {
    ...
    const currentTime = (0,_timezoneFormatter__WEBPACK_IMPORTED_MODULE_7__["default"])(timezone, new Date());

    if (currentTime.getTime() > (0,_timezoneFormatter__WEBPACK_IMPORTED_MODULE_7__["default"])(timezone, new Date(sunriseToday)).getTime()
    && currentTime.getTime() < (0,_timezoneFormatter__WEBPACK_IMPORTED_MODULE_7__["default"])(timezone, new Date(sunsetToday)).getTime()) {
    ...
    } else if (currentTime.getTime() > (0,_timezoneFormatter__WEBPACK_IMPORTED_MODULE_7__["default"])(timezone, new Date(sunriseToday)).getTime()
    && currentTime.getTime() > (0,_timezoneFormatter__WEBPACK_IMPORTED_MODULE_7__["default"])(timezone, new Date(sunsetToday)).getTime()) {
