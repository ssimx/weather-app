...
/* harmony import */ var _assets_gifs_heavy_snow_gif__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../assets/gifs/heavy-snow.gif */ "./src/assets/gifs/heavy-snow.gif");
/* harmony import */ var _assets_gifs_thunderstorm_gif__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../assets/gifs/thunderstorm.gif */ "./src/assets/gifs/thunderstorm.gif");
/* harmony import */ var _assets_icons_sunset_svg__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../assets/icons/sunset.svg */ "./src/assets/icons/sunset.svg");
/* harmony import */ var _assets_icons_sunrise_svg__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../assets/icons/sunrise.svg */ "./src/assets/icons/sunrise.svg");
/* harmony import */ var _assets_json_weatherCodes_json__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../assets/json/weatherCodes.json */ "./src/assets/json/weatherCodes.json");
/* harmony import */ var _tempBar__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./tempBar */ "./src/modules/tempBar.js");
/* harmony import */ var _timezoneFormatter__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./timezoneFormatter */ "./src/modules/timezoneFormatter.js");
/* harmony import */ var _pressureGauge__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./pressureGauge */ "./src/modules/pressureGauge.js");
...
const getWeatherType = (weatherCode, isDay) => {
    ...
    return _assets_json_weatherCodes_json__WEBPACK_IMPORTED_MODULE_24__[weatherCode][dayType];
};
    ...
    if (locationData.current.isDay === 0) {
        ...
        switch (weatherType.background) {
            ...
            case 'snow':
                ...
                break;
            case 'heavy-snow':
                body.style.backgroundImage = `url(${_assets_gifs_heavy_snow_gif__WEBPACK_IMPORTED_MODULE_20__})`;
                break;
            case 'thunderstorm':
                body.style.backgroundImage = `url(${_assets_gifs_thunderstorm_gif__WEBPACK_IMPORTED_MODULE_21__})`;
                break;
            default:
...
const updateDailyForecast = (locationData, systemType) => {
    ...
    for (let i = 7; i < 18; i++) {
        ...
        const barElement = (0,_tempBar__WEBPACK_IMPORTED_MODULE_25__["default"])(minTemp, maxTemp);
...
const updateSunriseSunset = (locationData) => {
    ...
    const currentTime = (0,_timezoneFormatter__WEBPACK_IMPORTED_MODULE_26__["default"])(timezone, new Date());

    if (currentTime.getTime() > (0,_timezoneFormatter__WEBPACK_IMPORTED_MODULE_26__["default"])(timezone, new Date(sunriseToday)).getTime()
    && currentTime.getTime() < (0,_timezoneFormatter__WEBPACK_IMPORTED_MODULE_26__["default"])(timezone, new Date(sunsetToday)).getTime()) {
        cardTitleText.textContent = 'Sunset';
        cardTitleIcon.src = _assets_icons_sunset_svg__WEBPACK_IMPORTED_MODULE_22__;
    ...
    } else if (currentTime.getTime() > (0,_timezoneFormatter__WEBPACK_IMPORTED_MODULE_26__["default"])(timezone, new Date(sunriseToday)).getTime()
    && currentTime.getTime() > (0,_timezoneFormatter__WEBPACK_IMPORTED_MODULE_26__["default"])(timezone, new Date(sunsetToday)).getTime()) {
        cardTitleText.textContent = 'Sunrise';
        cardTitleIcon.src = _assets_icons_sunrise_svg__WEBPACK_IMPORTED_MODULE_23__;
...
const updatePressure = (locationData) => {
    (0,_pressureGauge__WEBPACK_IMPORTED_MODULE_27__["default"])(Math.round(locationData.current.pressureMsl));
};
